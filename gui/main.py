...
class PPTGUI(QtGui.QWidget):
    ...
    def changesize1(self, value):      
        if self.cb1.isChecked():
            ...
            self.text13.show()
            self.cb2.setChecked(False)
            self.text2.setText("RunBundler --photos=" + self.text4.displayText() + " --featureExtractor=" + self.text15.displayText()+ " --maxPhotoDimension=" + self.text13.displayText())
    ...
    def onChangedpathbundler(self, text):
        if self.cb2.isChecked(): self.text2.setText("RunBundler --photos=" + self.text4.displayText() + " --featureExtractor=" + self.text15.displayText()+ " --photoScalingFactor=" + self.text11.displayText())
        if self.cb1.isChecked(): self.text2.setText("RunBundler --photos=" + self.text4.displayText() + " --featureExtractor=" + self.text15.displayText()+ " --maxPhotoDimension=" + self.text13.displayText())
...
# connection size-command
    ...
    def onChangedpathcmvs(self, text):
        self.text6.setText("RunCMVS --bundlerOutputPath=" + self.text3.displayText() + " --ClusterToCompute=" + self.text5.displayText())
...
# connection path-command
    def onChangedpathcamdat(self, text):
        self.text10.setText("RunBundler --photos=" + self.text9.displayText() + " --checkCameraDatabase")
